...
var LoginPage = (function () {
    ...
    LoginPage.prototype.ionViewDidLoad = function () {
        ...
        console.log(body);
        this.http.post('http://localhost:6001/api/get/participant', body, options).subscribe(function (res) {
